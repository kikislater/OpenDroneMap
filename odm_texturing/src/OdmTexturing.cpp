...
void OdmTexturing::blendImages()
{
        ...
        for (size_t cameraIndex = 0; cameraIndex < cameras_.size(); ++cameraIndex)
        {
            ...
            try
            {
                ...
                cameras_[cameraIndex].texture_file = blendedImagePathStream.str();
...
void OdmTexturing::blendImage(cv::Mat& image, size_t currentCameraIndex)
{
        ...
        for (int cameraIndex = 1; cameraIndex < nrCamerasToBlend_ + 1; ++cameraIndex, ++distanceIndexIterator)
        {
            ...
            {
                log_ << "Too few matches (< 100) in camera pair: " << currentCameraIndex << "-" << distanceIndexIterator->second << ".\n";
                continue;
            }
            ...
            {
                compensatorResize = 1200.0/textureWithSize_;
            }
...
void OdmTexturing::printHelp()
{
    ...
    log_ << "\"-outputBlendedImagesPath <path>\" (optional)\n";
    ...
    log_ << "\"-performBlending \" (default: false)\n";
    log_ << "If provided blending will be performed. Will increase computation time.\n";

    log_ << "\"-nrCamerasToBlend <integer>\" (optional, default: 5)\n";
